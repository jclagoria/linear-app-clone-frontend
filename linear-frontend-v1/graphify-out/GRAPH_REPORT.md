...
## Summary
- 927 nodes · 1453 edges · 102 communities (69 shown, 33 thin omitted)
...
- `IssueDetailProps` --references--> `Issue`  [EXTRACTED]
  entities/issue/ui/IssueDetail.tsx → entities/issue/model/types.ts
...
Cohesion: 0.12
Nodes (24): dispatchTable, dispatchToHandler(), ErrorHandler, ErrorHandlerRegistry, Guard, ApiError, FieldError, BusinessRuleError (+16 more)
...
Cohesion: 0.13
Nodes (12): ApiClient, ApiClientConfig, RequestInterceptor, RequestMethod, RequestOptions, ResponseInterceptor, authInterceptor(), errorInterceptor() (+4 more)
...
### Community 17 - "API Client Methods"
Cohesion: 0.24
Nodes (4): Watcher, WatcherItem(), WatcherItemProps, WatcherListProps

### Community 22 - "WebSocket Mock Server"
Cohesion: 0.33
...
- **Why does `MockWebSocket` connect `Keyboard Provider` to `Comment Thread Tests`?**
  _High betweenness centrality (0.005) - this node is a cross-community bridge._
