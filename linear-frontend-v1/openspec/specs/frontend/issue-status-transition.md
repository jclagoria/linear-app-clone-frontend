...
Allow users to transition an issue through its workflow statuses from the issue detail view. The status dropdown supports valid transitions, rejects invalid ones with error feedback, and handles loading/network-error states.
