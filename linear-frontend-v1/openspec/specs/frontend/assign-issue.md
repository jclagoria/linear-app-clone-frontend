...
Allow users to assign or unassign an issue to a team member via the dedicated `PATCH /issues/{id}/assignee` endpoint. The operation validates team membership on the server and displays appropriate user feedback.
